...
const EDITS = [
  ...
  },
  {
    ...
    // 2026-09-14: 6.70in の天井でも、特に長い1行（例: カナダの長文報告）1件で
    // 実際のMeiryoレンダリングが見積もりを上回り、出典行（6.86in）に重なった
    // （ネパール p.9、64%重なり）。天井をさらに 0.15in 切り上げて 6.55in にする。
    to: "  // 表の下端が 6.20in を越えないところまで。出典行は 6.86in、ページ番号は 7.14in。\n" +
        "  const TL_BUDGET = BI ? 5.05 : (6.20 - 1.30 - 0.38) * TBSCALE;",
  },
  {
    what: "被害の表の下端を上げる",
